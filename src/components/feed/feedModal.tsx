  ...
  return (
    <div
      className={`fixed inset-0 z-50 flex items-center justify-center transition-all duration-300 ${
        isOpen
          ...
          : 'pointer-events-none animate-fadeOutScale opacity-0'
      }`}
      aria-hidden={!isOpen}
      role="dialog"
      aria-modal="true"
    >
      <div
        ...
        onClick={closeModal}
      />
      <div className="relative h-4/5 max-h-screen w-3/5 transform animate-fadeInScale overflow-y-auto rounded-lg bg-white p-4 shadow-lg transition-transform duration-300 ph:h-full ph:w-full tab:h-full tab:w-full">
        <Button
          onClick={closeModal}
